...
(define-fun
  ...
  ((time Real)
    ...
    (tmp_14__AND_20_complete Bool) (tmp_16__BoolConstant_27_start Bool))
  Bool
  (and
    ...
    (=> tmp_16__BoolConstant_27_start tmp_14__AND_20_complete)
    (= tmp_0__AND_1_complete (and true (and tmp_9__BoolConstant_14_start tmp_16__BoolConstant_27_start))) (> time 0.0)))
(define-fun
  bmc_step
  ((time Real)
  ...
  (and
    ...
    (= tmp_0__AND_1_complete@ (and true (and tmp_9__BoolConstant_14_start@ tmp_16__BoolConstant_27_start@)))
...
(assert
  (bmc_init
    ...
    tmp_13__AND_20_start@0 tmp_14__AND_20_complete@0 tmp_16__BoolConstant_27_start@0))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@0 tmp_16__BoolConstant_27_start@1))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@1 tmp_16__BoolConstant_27_start@2))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@2 tmp_16__BoolConstant_27_start@3))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@3 tmp_16__BoolConstant_27_start@4))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@4 tmp_16__BoolConstant_27_start@5))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@5 tmp_16__BoolConstant_27_start@6))
(assert
  (bmc_step
    ...
    tmp_16__BoolConstant_27_start@6 tmp_16__BoolConstant_27_start@7))
(assert
  (bmc_target
    ...
    tmp_13__AND_20_start@7 tmp_14__AND_20_complete@7 tmp_16__BoolConstant_27_start@7))
